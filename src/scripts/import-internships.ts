...
if (fs.existsSync(envPath)) {
  ...
  // Add the MongoDB URI directly to process.env if needed
...
async function importInternships() {
  try {
    ...
    // First, remove all existing internships (the demo data)
    console.log("Removing existing internship data...");
    ...
    const internships = [
      ...
      },
      {
        ...
        location: "New York, NY",
        description:
          "Winter internship program for aspiring quantitative traders.",
    ...
    // Insert the new internship data
    console.log("Importing new internship data...");
