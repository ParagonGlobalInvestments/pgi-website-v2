...
export default function ResourcesPage() {
  ...
  useEffect(() => {
    ...
    const requireEdu = process.env.NEXT_PUBLIC_PGI_REQUIRE_EDU === 'true' || 
  ...
  const shouldShowEduError = isEduRequired && session?.user?.email && !isValidEduEmail(session.user.email);
        ...
        <div className="container mx-auto">
          ...
          >
            <motion.p
              ...
              variants={itemFadeIn}
            >
              Access exclusive educational materials, research templates, and resources 
              to support your journey in value investing and algorithmic trading.
            </motion.p>
          </motion.div>
              ...
              <div className="text-center">
                ...
                >
                  ...
                  <p className="text-gray-300 mb-8 text-base md:text-lg">
                    Sign in with your university Google account to access PGI's exclusive resources.
                  </p>
                  <Button
              ...
              <div className="text-center">
                ...
                >
                  ...
                  <p className="text-gray-300 mb-6 text-base md:text-lg">
                    Access to PGI resources is restricted to university students. 
                    Please sign in with your .edu email address.
                  </p>
                  ...
                  {!iframeError ? (
                    ...
                    <div className="text-center p-12 md:p-16">
                      ...
                      <p className="text-gray-300 mb-8 text-base md:text-lg">
                        ...
                        templates, and research resources.
                      </p>
                      <a
