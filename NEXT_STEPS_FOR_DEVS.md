...
**Delete these (they're gone from code, wevew moved from mongodb + clerk to pure supabase):**
 ...
 * ```
 */
export function syncUserWithSupabase(
...
5. **Write 1000+ line files** → Split into smaller modules
